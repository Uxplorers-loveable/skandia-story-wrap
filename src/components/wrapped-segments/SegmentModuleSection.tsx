      ...
      <div className="max-w-4xl mx-auto space-y-16">
        ...
        return <div key={module.id} className={`transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{
          transitionDelay: `${moduleIndex * 200}ms`
              ...
              {module.statCardsDisclaimer && <p className="text-xs text-muted-foreground text-center mb-8 -mt-4">
                ...
                transitionDelay: `${moduleIndex * 200 + cardIndex * 150 + 400}ms`
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1">
                            ...
                            {card.ctaLabel && (card.ctaUrl ? <a href={card.ctaUrl} target="_blank" rel="noopener noreferrer">
                                ...
                                </a> : <Button variant="outline" className="border-primary text-primary hover:bg-primary hover:text-primary-foreground transition-all">
                                  {card.ctaLabel}
                                  <ArrowRight className="w-4 h-4 ml-2" />
                                </Button>)}
                          </div>
            ...
            transitionDelay: `${moduleIndex * 200 + 700}ms`
                  ...
                  <div className="bg-muted border border-border rounded-2xl p-6 md:p-8 flex flex-col md:flex-row items-center gap-4 md:gap-6">
                    ...
                    <div className="flex-1 text-center md:text-left">
                      ...
                      <p className="text-muted-foreground">Te ayudará a entender en dónde están las oportunidades que pueden potenciar tu nivel.</p>
                    </div>
