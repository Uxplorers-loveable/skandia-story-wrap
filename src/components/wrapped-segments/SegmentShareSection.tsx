      ...
      <div className="max-w-4xl mx-auto">
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="mt-12 px-4">
            <p className="text-muted-foreground text-xs leading-relaxed text-center">El contenido de la presente comunicación no constituye una recomendación profesional para realizar inversiones, en los términos del artículo 2.40.1.1.2 del Decreto 2555 de 2010. La Publicación no constituye recomendación, sugerencia, consejo ni asesoría alguna para la toma de decisiones. Skandia no promete ni garantiza el capital ni la obtención de rentabilidad, las obligaciones de Skandia son de medio y no de resultado. Skandia INVEST-ED es un servicio que pertenece a la plataforma del Fondo Voluntario de Pensión Skandia Multifund, administrado por Skandia AFP - ACCAI S.A. Los portafolios pertenecientes al Fondo Voluntario de Pensión Skandia Multifund son distintos a los Fondos Obligatorios de Pensiones que prevé la Ley 100 de 1993. Fondo Voluntario de Pensión, administrado por Skandia AFP - ACCAI S.A. Los portafolios pertenecientes al Fondo Voluntario de Pensión Skandia Multifund son distintos a los Fondos Obligatorios de Pensiones que prevé la Ley 100 de 1993.</p>
          </div>
